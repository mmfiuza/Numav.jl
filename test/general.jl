...
@test_throws ArgumentError add_sound_source!(s, coordinates=[[1,2],[1,1,1]], pressure=1)
...
add_sound_source!(s, coordinates=[[1.0, 1.0, 1.0], [1,1,1]], pressure=f->f)
add_sound_source!(s, coordinates=[[1.0, 1.0, 1.0], [1,1,1]], pressure=1)
add_sound_source!(s, coordinates=[[1.0, 1.0, 1.0], [1,1,1]], pressure=pqv)
add_sound_source!(s, physical_group=4, pressure=f->f)
add_sound_source!(s, physical_group=[5,6], pressure=1)
...
load_mesh!(s, mesh_path)
add_volume_material!(s, physical_group=[1,2,3], density=1, speed_of_sound=1)
add_surface_material!(s, physical_group=[7,8,9], specific_acoustic_impedance=1)
